...
path = 'C:\Users\LIlaJeff\Downloads\RePorter'
...
for year in years:
    ...
    trim_frame[['APPLICATION_ID', 'ACTIVITY', 'PI_NAME', 'ORG_NAME', 'ORG_CITY']] = frame[['APPLICATION_ID', 'ACTIVITY', 'PI_NAME', 'ORG_NAME', 'ORG_CITY']]
